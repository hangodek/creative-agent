...
name: design-clay
description: >
  Apply the Clay design system: Creative agency. Organic shapes, soft gradients, art-directed layout
  Use when designing UI components, pages, dashboards, or full applications in the Clay aesthetic.
  Trigger on "Clay", "clay", or requests matching this visual language.
---
