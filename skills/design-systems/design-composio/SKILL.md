...
description: >
  Apply the Composio design system: Tool integration platform. Modern dark with colorful integration icons
  Use when designing UI components, pages, dashboards, or full applications in the Composio aesthetic.
  Trigger on "Composio", "composio", or requests matching this visual language.
---
