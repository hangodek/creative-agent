---
name: design-dell-1996
description: >
  Apply the Dell (1996) design system: Catalog-era enterprise web. Literal black page frame, flat color-block 'ribbon cards', chunky Helvetica-Black titles over Times Roman body, and hand-cut GIF stickers (NEW! bursts, award seals, beveled product photos).
  Use when designing UI components, pages, dashboards, or full applications in the Dell (1996) aesthetic.
  Trigger on "Dell (1996)", "dell-1996", or requests matching this visual language.
---
