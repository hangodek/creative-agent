...
name: design-cohere
description: >
  Apply the Cohere design system: Enterprise AI platform. Vibrant gradients, data-rich dashboard aesthetic
  Use when designing UI components, pages, dashboards, or full applications in the Cohere aesthetic.
  Trigger on "Cohere", "cohere", or requests matching this visual language.
---
