...
name: design-notion
description: >
  Apply the Notion design system: All-in-one workspace. Warm minimalism, serif headings, soft surfaces
  Use when designing UI components, pages, dashboards, or full applications in the Notion aesthetic.
  Trigger on "Notion", "notion", or requests matching this visual language.
---
