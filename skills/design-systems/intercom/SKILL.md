...
description: "Apply the Intercom design system: Customer messaging. Friendly blue palette, conversational UI patterns Use when designing UI components, landing pages, dashboards, or full applications in the Intercom aesthetic. Trigger on "Intercom", "intercom", or requests matching this visual language."
---
