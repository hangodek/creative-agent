...
name: design-binance
description: >
  Apply the Binance design system: Crypto exchange. Bold Binance Yellow on monochrome, trading-floor urgency
  Use when designing UI components, pages, dashboards, or full applications in the Binance aesthetic.
  Trigger on "Binance", "binance", or requests matching this visual language.
---
