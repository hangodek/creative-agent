...
name: design-nvidia
description: >
  Apply the NVIDIA design system: GPU computing. Green-black energy, technical power aesthetic
  Use when designing UI components, pages, dashboards, or full applications in the NVIDIA aesthetic.
  Trigger on "NVIDIA", "nvidia", or requests matching this visual language.
---
