...
description: "Apply the Runway design system: AI creative-tools platform with an editorial film-festival aesthetic — cinematic dark heroes, paper-white reading bands, single proprietary sans, and pure black pill CTAs. Use when designing UI components, landing pages, dashboards, or full applications in the Runway aesthetic. Trigger on "Runway", "runwayml", or requests matching this visual language."
---
