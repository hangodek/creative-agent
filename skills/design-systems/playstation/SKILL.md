...
description: "Apply the PlayStation design system: Gaming console retail. Three-surface channel layout, cyan hover-scale interaction Use when designing UI components, landing pages, dashboards, or full applications in the PlayStation aesthetic. Trigger on "PlayStation", "playstation", or requests matching this visual language."
---
