...
name: design-bmw-m
description: >
  Apply the BMW M design system: Performance automotive. Motorsport-inspired contrast, M color accents, precision-driven layout
  Use when designing UI components, pages, dashboards, or full applications in the BMW M aesthetic.
  Trigger on "BMW M", "bmw-m", or requests matching this visual language.
---
