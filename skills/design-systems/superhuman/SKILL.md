...
description: "Apply the Superhuman design system: Fast email client. Premium dark UI, keyboard-first, purple glow Use when designing UI components, landing pages, dashboards, or full applications in the Superhuman aesthetic. Trigger on "Superhuman", "superhuman", or requests matching this visual language."
---
