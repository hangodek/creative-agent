...
name: design-stripe
description: >
  Apply the Stripe design system: Payment infrastructure. Signature purple gradients, weight-300 elegance
  Use when designing UI components, pages, dashboards, or full applications in the Stripe aesthetic.
  Trigger on "Stripe", "stripe", or requests matching this visual language.
---
