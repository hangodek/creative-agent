...
name: design-slack
description: >
  Apply the Slack design system: Visual design system and tokens inspired by slack.
  Use when designing UI components, pages, dashboards, or full applications in the Slack aesthetic.
  Trigger on "Slack", "slack", or requests matching this visual language.
---
