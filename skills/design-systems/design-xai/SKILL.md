...
name: design-xai
description: >
  Apply the xAI design system: Elon Musk's AI lab. Stark monochrome, futuristic minimalism
  Use when designing UI components, pages, dashboards, or full applications in the xAI aesthetic.
  Trigger on "xAI", "xai", or requests matching this visual language.
---
