...
name: design-mistral
description: >
  Apply the Mistral AI design system: Open-weight LLM provider. French-engineered minimalism, purple-toned
  Use when designing UI components, pages, dashboards, or full applications in the Mistral AI aesthetic.
  Trigger on "Mistral AI", "mistral", or requests matching this visual language.
---
