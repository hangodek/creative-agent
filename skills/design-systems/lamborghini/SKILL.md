...
description: "Apply the Lamborghini design system: Luxury automotive. True black cathedral, gold accent, LamboType custom Neo-Grotesk Use when designing UI components, landing pages, dashboards, or full applications in the Lamborghini aesthetic. Trigger on "Lamborghini", "lamborghini", or requests matching this visual language."
---
