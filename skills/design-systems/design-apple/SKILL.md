...
name: design-apple
description: >
  Apply the Apple design system: Consumer electronics. Premium white space, SF Pro, cinematic imagery
  Use when designing UI components, pages, dashboards, or full applications in the Apple aesthetic.
  Trigger on "Apple", "apple", or requests matching this visual language.
---
