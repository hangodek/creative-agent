...
name: design-figma
description: >
  Apply the Figma design system: Collaborative design tool. Vibrant multi-color, playful yet professional
  Use when designing UI components, pages, dashboards, or full applications in the Figma aesthetic.
  Trigger on "Figma", "figma", or requests matching this visual language.
---
