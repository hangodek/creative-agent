...
name: design-uber
description: >
  Apply the Uber design system: Mobility platform. Bold black and white, tight type, urban energy
  Use when designing UI components, pages, dashboards, or full applications in the Uber aesthetic.
  Trigger on "Uber", "uber", or requests matching this visual language.
---
