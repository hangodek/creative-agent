...
description: >
  Apply the OpenCode AI design system: AI coding platform. Developer-centric dark theme
  Use when designing UI components, pages, dashboards, or full applications in the OpenCode AI aesthetic.
  Trigger on "OpenCode AI", "opencode-ai", or requests matching this visual language.
---
