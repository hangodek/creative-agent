...
name: design-linear
description: >
  Apply the Linear design system: Project management for engineers. Ultra-minimal, precise, purple accent
  Use when designing UI components, pages, dashboards, or full applications in the Linear aesthetic.
  Trigger on "Linear", "linear", or requests matching this visual language.
---
