...
name: design-vercel
description: >
  Apply the Vercel design system: Frontend deployment platform. Black and white precision, Geist font
  Use when designing UI components, pages, dashboards, or full applications in the Vercel aesthetic.
  Trigger on "Vercel", "vercel", or requests matching this visual language.
---
