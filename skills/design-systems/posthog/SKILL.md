---
name: design-posthog
description: "Apply the PostHog design system: Product analytics. Playful hedgehog branding, developer-friendly dark UI Use when designing UI components, landing pages, dashboards, or full applications in the PostHog aesthetic. Trigger on "PostHog", "posthog", or requests matching this visual language."
---
