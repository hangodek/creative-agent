...
name: design-claude
description: >
  Apply the Claude design system: Anthropic's AI assistant. Warm terracotta accent, clean editorial layout
  Use when designing UI components, pages, dashboards, or full applications in the Claude aesthetic.
  Trigger on "Claude", "claude", or requests matching this visual language.
---
