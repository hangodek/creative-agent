...
description: "Apply the Airtable design system: Spreadsheet-database hybrid. Colorful, friendly, structured data aesthetic Use when designing UI components, landing pages, dashboards, or full applications in the Airtable aesthetic. Trigger on "Airtable", "airtable", or requests matching this visual language."
---
