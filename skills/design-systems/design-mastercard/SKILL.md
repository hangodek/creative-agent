...
description: >
  Apply the Mastercard design system: Global payments network. Warm cream canvas, orbital pill shapes, editorial warmth
  Use when designing UI components, pages, dashboards, or full applications in the Mastercard aesthetic.
  Trigger on "Mastercard", "mastercard", or requests matching this visual language.
---
