...
description: >
  Apply the Pinterest design system: Visual discovery platform. Red accent, masonry grid, image-first
  Use when designing UI components, pages, dashboards, or full applications in the Pinterest aesthetic.
  Trigger on "Pinterest", "pinterest", or requests matching this visual language.
---
