...
name: design-meta
description: >
  Apply the Meta design system: Tech retail store. Photography-first, binary light/dark surfaces, Meta Blue CTAs
  Use when designing UI components, pages, dashboards, or full applications in the Meta aesthetic.
  Trigger on "Meta", "meta", or requests matching this visual language.
---
