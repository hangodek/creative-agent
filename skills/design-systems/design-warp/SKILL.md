...
name: design-warp
description: >
  Apply the Warp design system: Modern terminal. Dark IDE-like interface, block-based command UI
  Use when designing UI components, pages, dashboards, or full applications in the Warp aesthetic.
  Trigger on "Warp", "warp", or requests matching this visual language.
---
