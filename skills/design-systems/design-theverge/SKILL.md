...
description: >
  Apply the The Verge design system: Tech editorial media. Acid-mint and ultraviolet accents, Manuka display type
  Use when designing UI components, pages, dashboards, or full applications in the The Verge aesthetic.
  Trigger on "The Verge", "theverge", or requests matching this visual language.
---
