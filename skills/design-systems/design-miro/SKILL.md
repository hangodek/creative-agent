...
name: design-miro
description: >
  Apply the Miro design system: Visual collaboration. Bright yellow accent, infinite canvas aesthetic
  Use when designing UI components, pages, dashboards, or full applications in the Miro aesthetic.
  Trigger on "Miro", "miro", or requests matching this visual language.
---
