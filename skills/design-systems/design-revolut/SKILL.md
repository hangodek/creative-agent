...
name: design-revolut
description: >
  Apply the Revolut design system: Digital banking. Sleek dark interface, gradient cards, fintech precision
  Use when designing UI components, pages, dashboards, or full applications in the Revolut aesthetic.
  Trigger on "Revolut", "revolut", or requests matching this visual language.
---
