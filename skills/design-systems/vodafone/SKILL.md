...
description: "Apply the Vodafone design system: Global telecom brand. Monumental uppercase display, Vodafone Red chapter bands Use when designing UI components, landing pages, dashboards, or full applications in the Vodafone aesthetic. Trigger on "Vodafone", "vodafone", or requests matching this visual language."
---
