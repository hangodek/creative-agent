...
name: design-expo
description: >
  Apply the Expo design system: React Native platform. Dark theme, tight letter-spacing, code-centric
  Use when designing UI components, pages, dashboards, or full applications in the Expo aesthetic.
  Trigger on "Expo", "expo", or requests matching this visual language.
---
