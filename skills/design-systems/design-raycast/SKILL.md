...
name: design-raycast
description: >
  Apply the Raycast design system: Productivity launcher. Sleek dark chrome, vibrant gradient accents
  Use when designing UI components, pages, dashboards, or full applications in the Raycast aesthetic.
  Trigger on "Raycast", "raycast", or requests matching this visual language.
---
