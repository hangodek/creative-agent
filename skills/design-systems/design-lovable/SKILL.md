...
name: design-lovable
description: >
  Apply the Lovable design system: AI full-stack builder. Playful gradients, friendly dev aesthetic
  Use when designing UI components, pages, dashboards, or full applications in the Lovable aesthetic.
  Trigger on "Lovable", "lovable", or requests matching this visual language.
---
