...
description: "Apply the Supabase design system: Open-source Firebase alternative. Dark emerald theme, code-first Use when designing UI components, landing pages, dashboards, or full applications in the Supabase aesthetic. Trigger on "Supabase", "supabase", or requests matching this visual language."
---
