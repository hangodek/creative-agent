...
name: design-spotify
description: >
  Apply the Spotify design system: Music streaming. Vibrant green on dark, bold type, album-art-driven
  Use when designing UI components, pages, dashboards, or full applications in the Spotify aesthetic.
  Trigger on "Spotify", "spotify", or requests matching this visual language.
---
