...
name: design-renault
description: >
  Apply the Renault design system: French automotive. Vivid aurora gradients, NouvelR proprietary typeface, zero-radius buttons
  Use when designing UI components, pages, dashboards, or full applications in the Renault aesthetic.
  Trigger on "Renault", "renault", or requests matching this visual language.
---
