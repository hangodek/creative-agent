...
name: design-sentry
description: >
  Apply the Sentry design system: Error monitoring. Dark dashboard, data-dense, pink-purple accent
  Use when designing UI components, pages, dashboards, or full applications in the Sentry aesthetic.
  Trigger on "Sentry", "sentry", or requests matching this visual language.
---
