...
description: >
  Apply the HashiCorp design system: Infrastructure automation. Enterprise-clean, black and white
  Use when designing UI components, pages, dashboards, or full applications in the HashiCorp aesthetic.
  Trigger on "HashiCorp", "hashicorp", or requests matching this visual language.
---
