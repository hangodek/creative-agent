...
name: design-spacex
description: >
  Apply the SpaceX design system: Space technology. Stark black and white, full-bleed imagery, futuristic
  Use when designing UI components, pages, dashboards, or full applications in the SpaceX aesthetic.
  Trigger on "SpaceX", "spacex", or requests matching this visual language.
---
