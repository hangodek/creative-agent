...
name: design-framer
description: >
  Apply the Framer design system: Website builder. Bold black and blue, motion-first, design-forward
  Use when designing UI components, pages, dashboards, or full applications in the Framer aesthetic.
  Trigger on "Framer", "framer", or requests matching this visual language.
---
