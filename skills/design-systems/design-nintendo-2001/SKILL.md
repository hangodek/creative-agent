...
description: >
  Apply the Nintendo.com (2001) design system: Y2K 'console chrome' web. Brushed-periwinkle beveled metal panels, a halftone-dotted carbon nav glowing amber, outlined Arial-Black box-art wordmarks over circuit-board hero fields, and a pixel Mario welcome bubble.
  Use when designing UI components, pages, dashboards, or full applications in the Nintendo.com (2001) aesthetic.
  Trigger on "Nintendo.com (2001)", "nintendo-2001", or requests matching this visual language.
---
