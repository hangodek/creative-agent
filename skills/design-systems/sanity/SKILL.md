---
name: design-sanity
description: "Apply the Sanity design system: Headless content platform with a dark-first editorial marketing surface — 112px display type, IBM Plex Mono technical eyebrows, and a single coral-red accent reserved for the highest-priority CTA. Use when designing UI components, landing pages, dashboards, or full applications in the Sanity aesthetic. Trigger on "Sanity", "sanity", or requests matching this visual language."
---
