...
name: design-hp
description: >
  Apply the HP design system: PC and printer maker. Pure white canvas, HP Electric Blue signal CTA, geometric Forma DJR Micro, blue chevron decorations
  Use when designing UI components, pages, dashboards, or full applications in the HP aesthetic.
  Trigger on "HP", "hp", or requests matching this visual language.
---
