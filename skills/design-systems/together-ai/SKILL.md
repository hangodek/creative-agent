...
description: "Apply the Together AI design system: Open-source AI infrastructure. Technical, blueprint-style design Use when designing UI components, landing pages, dashboards, or full applications in the Together AI aesthetic. Trigger on "Together AI", "together-ai", or requests matching this visual language."
---
