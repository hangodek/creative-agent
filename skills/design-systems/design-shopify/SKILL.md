...
name: design-shopify
description: >
  Apply the Shopify design system: E-commerce platform. Dark-first cinematic, neon green accent, ultra-light display type
  Use when designing UI components, pages, dashboards, or full applications in the Shopify aesthetic.
  Trigger on "Shopify", "shopify", or requests matching this visual language.
---
