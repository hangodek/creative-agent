...
name: design-kraken
description: >
  Apply the Kraken design system: Crypto trading platform. Purple-accented dark UI, data-dense dashboards
  Use when designing UI components, pages, dashboards, or full applications in the Kraken aesthetic.
  Trigger on "Kraken", "kraken", or requests matching this visual language.
---
