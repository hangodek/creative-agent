...
name: design-wired
description: >
  Apply the WIRED design system: Tech magazine. Paper-white broadsheet density, custom serif, ink-blue links
  Use when designing UI components, pages, dashboards, or full applications in the WIRED aesthetic.
  Trigger on "WIRED", "wired", or requests matching this visual language.
---
