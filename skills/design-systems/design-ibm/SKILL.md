...
name: design-ibm
description: >
  Apply the IBM design system: Enterprise technology. Carbon design system, structured blue palette
  Use when designing UI components, pages, dashboards, or full applications in the IBM aesthetic.
  Trigger on "IBM", "ibm", or requests matching this visual language.
---
