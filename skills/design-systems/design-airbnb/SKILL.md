...
name: design-airbnb
description: >
  Apply the Airbnb design system: Travel marketplace. Warm coral accent, photography-driven, rounded UI
  Use when designing UI components, pages, dashboards, or full applications in the Airbnb aesthetic.
  Trigger on "Airbnb", "airbnb", or requests matching this visual language.
---
