...
description: >
  Apply the ClickHouse design system: Fast analytics database. Yellow-accented, technical documentation style
  Use when designing UI components, pages, dashboards, or full applications in the ClickHouse aesthetic.
  Trigger on "ClickHouse", "clickhouse", or requests matching this visual language.
---
