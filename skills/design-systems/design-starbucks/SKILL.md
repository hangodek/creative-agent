...
description: >
  Apply the Starbucks design system: Coffee retail flagship. Four-tier earth-green system, warm cream canvas, proprietary SoDoSans typography
  Use when designing UI components, pages, dashboards, or full applications in the Starbucks aesthetic.
  Trigger on "Starbucks", "starbucks", or requests matching this visual language.
---
