...
name: design-tesla
description: >
  Apply the Tesla design system: Electric vehicles. Radical subtraction, cinematic full-viewport photography, Universal Sans
  Use when designing UI components, pages, dashboards, or full applications in the Tesla aesthetic.
  Trigger on "Tesla", "tesla", or requests matching this visual language.
---
