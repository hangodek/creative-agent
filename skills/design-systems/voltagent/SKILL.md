...
description: "Apply the VoltAgent design system: AI agent framework. Void-black canvas, emerald accent, terminal-native Use when designing UI components, landing pages, dashboards, or full applications in the VoltAgent aesthetic. Trigger on "VoltAgent", "voltagent", or requests matching this visual language."
---
