...
name: design-zapier
description: >
  Apply the Zapier design system: Automation platform. Warm orange, friendly illustration-driven
  Use when designing UI components, pages, dashboards, or full applications in the Zapier aesthetic.
  Trigger on "Zapier", "zapier", or requests matching this visual language.
---
