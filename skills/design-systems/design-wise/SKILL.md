...
name: design-wise
description: >
  Apply the Wise design system: International money transfer. Bright green accent, friendly and clear
  Use when designing UI components, pages, dashboards, or full applications in the Wise aesthetic.
  Trigger on "Wise", "wise", or requests matching this visual language.
---
