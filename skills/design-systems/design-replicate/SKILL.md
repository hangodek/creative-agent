...
description: >
  Apply the Replicate design system: Run ML models via API. Clean white canvas, code-forward
  Use when designing UI components, pages, dashboards, or full applications in the Replicate aesthetic.
  Trigger on "Replicate", "replicate", or requests matching this visual language.
---
