---
name: design-mongodb
description: "Apply the MongoDB design system: Document database. Green leaf branding, developer documentation focus Use when designing UI components, landing pages, dashboards, or full applications in the MongoDB aesthetic. Trigger on "MongoDB", "mongodb", or requests matching this visual language."
---
