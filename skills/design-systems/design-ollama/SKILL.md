...
name: design-ollama
description: >
  Apply the Ollama design system: Run LLMs locally. Terminal-first, monochrome simplicity
  Use when designing UI components, pages, dashboards, or full applications in the Ollama aesthetic.
  Trigger on "Ollama", "ollama", or requests matching this visual language.
---
