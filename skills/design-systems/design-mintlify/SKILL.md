...
description: >
  Apply the Mintlify design system: Documentation platform. Clean, green-accented, reading-optimized
  Use when designing UI components, pages, dashboards, or full applications in the Mintlify aesthetic.
  Trigger on "Mintlify", "mintlify", or requests matching this visual language.
---
