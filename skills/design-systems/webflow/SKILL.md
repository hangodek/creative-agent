---
name: design-webflow
description: "Apply the Webflow design system: Visual web builder. Blue-accented, polished marketing site aesthetic Use when designing UI components, landing pages, dashboards, or full applications in the Webflow aesthetic. Trigger on "Webflow", "webflow", or requests matching this visual language."
---
