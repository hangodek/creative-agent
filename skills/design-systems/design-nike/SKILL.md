...
name: design-nike
description: >
  Apply the Nike design system: Athletic retail. Monochrome UI, massive uppercase Futura, full-bleed photography
  Use when designing UI components, pages, dashboards, or full applications in the Nike aesthetic.
  Trigger on "Nike", "nike", or requests matching this visual language.
---
