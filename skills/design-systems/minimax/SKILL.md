---
name: design-minimax
description: "Apply the Minimax design system: AI model provider. Bold dark interface with neon accents Use when designing UI components, landing pages, dashboards, or full applications in the Minimax aesthetic. Trigger on "Minimax", "minimax", or requests matching this visual language."
---
