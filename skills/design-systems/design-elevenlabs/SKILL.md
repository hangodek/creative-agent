...
description: >
  Apply the ElevenLabs design system: AI voice platform. Dark cinematic UI, audio-waveform aesthetics
  Use when designing UI components, pages, dashboards, or full applications in the ElevenLabs aesthetic.
  Trigger on "ElevenLabs", "elevenlabs", or requests matching this visual language.
---
