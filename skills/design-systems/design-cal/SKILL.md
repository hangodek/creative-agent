...
name: design-cal
description: >
  Apply the Cal.com design system: Open-source scheduling. Clean neutral UI, developer-oriented simplicity
  Use when designing UI components, pages, dashboards, or full applications in the Cal.com aesthetic.
  Trigger on "Cal.com", "cal", or requests matching this visual language.
---
