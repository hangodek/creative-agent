...
name: design-ferrari
description: >
  Apply the Ferrari design system: Luxury automotive. Chiaroscuro black-white editorial, Ferrari Red with extreme sparseness
  Use when designing UI components, pages, dashboards, or full applications in the Ferrari aesthetic.
  Trigger on "Ferrari", "ferrari", or requests matching this visual language.
---
