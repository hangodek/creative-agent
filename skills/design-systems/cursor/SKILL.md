---
name: design-cursor
description: "Apply the Cursor design system: AI-first code editor. Sleek dark interface, gradient accents Use when designing UI components, landing pages, dashboards, or full applications in the Cursor aesthetic. Trigger on "Cursor", "cursor", or requests matching this visual language."
---
