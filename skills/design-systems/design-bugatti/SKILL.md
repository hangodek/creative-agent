...
name: design-bugatti
description: >
  Apply the Bugatti design system: Luxury hypercar. Cinema-black canvas, monochrome austerity, monumental display type
  Use when designing UI components, pages, dashboards, or full applications in the Bugatti aesthetic.
  Trigger on "Bugatti", "bugatti", or requests matching this visual language.
---
