...
description: >
  Apply the Coinbase design system: Crypto exchange. Clean blue identity, trust-focused, institutional feel
  Use when designing UI components, pages, dashboards, or full applications in the Coinbase aesthetic.
  Trigger on "Coinbase", "coinbase", or requests matching this visual language.
---
