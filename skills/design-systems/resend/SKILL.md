---
name: design-resend
description: "Apply the Resend design system: Email API for developers. Minimal dark theme, monospace accents Use when designing UI components, landing pages, dashboards, or full applications in the Resend aesthetic. Trigger on "Resend", "resend", or requests matching this visual language."
---
